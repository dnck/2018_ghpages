...
Note: <a href = "https://github.com/dnck/dnck.github.io/blob/master/_data/knn_on_sep.py">if you decide to run this code, the function preprocess() is still incredibly time consuming because I suck at sanitizing text.</a>
